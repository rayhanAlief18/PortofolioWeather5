...
export default function index() {
    return (
        ...
        <div className='w-full flex space-x-5 overflow-scroll p-16 snap-x snap-mandatory overflow-y-hidden'>
            <MyProject image="WheaterApp.png" judul="Wheater App" namaApp={"WheaterApp/Index"} desc="Berada dalam portofolio ini, dibuat menggunakan next js dan tailwind css serta mengambil API dari Openweather"/>
